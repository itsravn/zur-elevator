...
- **Güvenli Kod Yapısı**: İstemci ve arayüz kodları izinsiz kullanıma karşı şifrelenmiştir. Ancak `config.lua` üzerinden istenildiği kadar yeni kat ve asansör eklenebilir.
